...
from gl_updater import GL_Updater
...
def main():
    ...
    parser.add_argument('--discriminator', '-d', default='',
                        help='Discriminator. [.npz] (must)')
    ...
    dis = Discriminator(global_size=args.cut_size, local_size=args.local_size)
    com = CompletionNet()
    ...
    # Setup an optimizer
    def make_optimizer(model, rho=0.95): # rhoはとりあえずDCGANと同じ値(デフォルト)
    ...
    trainer.extend(extensions.PrintReport([
        'epoch', 'iteration', 'com/loss', 'dis/loss',
